...
#ifndef __JPEGENC__
#define __JPEGENC__
#if defined( MICROPY_PY_SENSOR ) || defined( __MACH__ ) || defined( __LINUX__ ) || defined( __MCUXPRESSO ) || defined( ESP_PLATFORM ) || defined( STM32H562xx ) || defined( STM32H5 ) || defined( __arm__ )
#include <stdlib.h>
#include <string.h>
#include <stdint.h>
#include <stdio.h>
